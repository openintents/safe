...
public class Engine {
        ...
        synchronized (_cphMks) {
            ...
            if (null == maker) {
                throw new ESJException(
                        "no maker registered for cipher \"" +
                                name + "\""
                );
            }
        }
    ...
    static Class[] _cipherClasses =
            {
                    //org.estreamj.ciphers.phelix.Phelix.class,
                    //org.estreamj.ciphers.hc256.HC256.class,
                    //org.estreamj.ciphers.salsa20.Salsa20.class,
                    //org.estreamj.ciphers.aes.AESCTR.class,
                    //org.estreamj.ciphers.mickey.MICKEY.class,
                    //org.estreamj.ciphers.mickey.MICKEY128.class,
                    //org.estreamj.ciphers.hermes8.Hermes8.class,
                    //org.estreamj.ciphers.rc4.RC4.class,
                    //org.estreamj.ciphers.dragon.Dragon.class,
                    //org.estreamj.ciphers.lex.LEX.class,
                    estreamj.ciphers.trivium.Trivium.class//,
                    //org.estreamj.ciphers.sosemanuk.Sosemanuk.class,
                    //org.estreamj.ciphers.grain.GrainP2.class,
                    //org.estreamj.ciphers.grain.Grain128.class,
                    //org.estreamj.ciphers.nil.Nil.class
            };
