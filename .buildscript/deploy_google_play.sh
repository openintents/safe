...
# and https://github.com/gdg-x/frisbee
...
commitAndPushToGit () {
  ...
  git push -q https://$ORGA:$GITHUB_API_KEY@github.com/$SLUG 2>/dev/null
  git push -q --tags https://$ORGA:$GITHUB_API_KEY@github.com/$SLUG 2>/dev/null
}
